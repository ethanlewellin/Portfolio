...
labels:
  ...
  - Machine Learning
  - NumPy
summary: "Implementation of core neural network components entirely from scratch in Python and NumPy, following Harrison Kinsley and Daniel Kukiela's *Neural Networks from Scratch*."
---
